...
public class NulisSatuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        canvasFragments.add(new CanvasFragment("alif"));
        canvasFragments.add(new CanvasFragment("ba"));
        canvasFragments.add(new CanvasFragment("ta"));
        canvasFragments.add(new CanvasFragment("tsa"));
        canvasFragments.add(new CanvasFragment("jim"));
