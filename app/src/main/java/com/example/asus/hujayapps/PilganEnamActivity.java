...
public class PilganEnamActivity extends AppCompatActivity {
    ...
    SoalPilihanGandaEnam soalPG = new SoalPilihanGandaEnam();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pilgan_enam);
    ...
    public void setKonten(){
        ...
        arr = soalPG.pertanyaanenam.length;
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(PilganEnamActivity.this, HasilSkoringActivity.class);
