...
public class EsayDuaActivity extends AppCompatActivity {
    ...
    SoalEsayDua essay = new SoalEsayDua();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_esay_dua);
    ...
    public void setKonten(){
        ...
        arr = essay.pertanyaanesaydua.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(EsayDuaActivity.this, HasilSkoringActivity.class);
