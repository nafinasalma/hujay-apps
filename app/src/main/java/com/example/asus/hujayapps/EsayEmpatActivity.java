...
public class EsayEmpatActivity extends AppCompatActivity {
    ...
    SoalEmpatEsay essay = new SoalEmpatEsay();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_esay_empat);
    ...
    public void setKonten(){
        ...
        arr = essay.pertanyaanesayempat.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(EsayEmpatActivity.this, HasilSkoringActivity.class);
