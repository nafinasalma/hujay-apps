...
public class PilganLimaActivity extends AppCompatActivity {
    ...
    SoalPilihanGandaLima soalPG = new SoalPilihanGandaLima();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pilgan_lima);
    ...
    public void setKonten(){
        ...
        arr = soalPG.pertanyaanlima.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(PilganLimaActivity.this, HasilSkoringActivity.class);
