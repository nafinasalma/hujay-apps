...
public class PilganEmpatActivity extends AppCompatActivity {
    ...
    SoalPilihanGandaEmpat soalPG = new SoalPilihanGandaEmpat();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pilgan_empat);
    ...
    public void setKonten(){
        ...
        arr = soalPG.pertanyaanempat.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(PilganEmpatActivity.this, HasilSkoringActivity.class);
