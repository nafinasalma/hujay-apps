...
public class EsayEnamActivity extends AppCompatActivity {
    ...
    SoalEsayEnam essay = new SoalEsayEnam();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_esay_enam);
    ...
    public void setKonten(){
        ...
        arr = essay.pertanyaanesayenam.length;
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(EsayEnamActivity.this, HasilSkoringActivity.class);
