...
public class PilganTigaActivity extends AppCompatActivity {
    ...
    SoalPilihanGandaTiga soalPG = new SoalPilihanGandaTiga();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pilgan_tiga);
    ...
    public void setKonten(){
        ...
        arr = soalPG.pertanyaantiga.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(PilganTigaActivity.this, HasilSkoringActivity.class);
