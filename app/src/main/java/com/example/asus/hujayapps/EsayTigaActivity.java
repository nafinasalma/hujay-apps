...
public class EsayTigaActivity extends AppCompatActivity {
    ...
    SoalEsayTiga essay = new SoalEsayTiga();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_esay_tiga);
    ...
    public void setKonten(){
        ...
        arr = essay.pertanyaanesaytiga.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(EsayTigaActivity.this, HasilSkoringActivity.class);
