...
public class NulisDuaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        canvasFragments.add(new CanvasFragment("ha"));
        canvasFragments.add(new CanvasFragment("kho"));
        canvasFragments.add(new CanvasFragment("dal"));
        canvasFragments.add(new CanvasFragment("dzal"));
        canvasFragments.add(new CanvasFragment("ro"));
