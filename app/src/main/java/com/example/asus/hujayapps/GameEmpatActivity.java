...
public class GameEmpatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_empat);
...
//            tv_p1.setText("Poin: " + playerPoints);
    ...
    private void checkEnd() {
        if (back_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GameEmpatActivity.this);
            alertDialogBuilder
//                    .setMessage("PERMAINAN SELESAI!\nPoin Kamu: " + playerPoints )
                    ...
                    .setPositiveButton("Permainan Baru", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), GameEmpatActivity.class);
    ...
    private void frontOfCardsResources() {
        gambar101 = R.drawable.thogame;
        gambar102 = R.drawable.fagame;
        gambar103 = R.drawable.dzogame;
        gambar104 = R.drawable.aingame;
        gambar105 = R.drawable.ghoingame;
        gambar201 = R.drawable.thogame2;
        gambar202 = R.drawable.fagame2;
        gambar203 = R.drawable.dzogame2;
        gambar204 = R.drawable.aingame2;
        gambar205 = R.drawable.ghoingame2;
    }
}
