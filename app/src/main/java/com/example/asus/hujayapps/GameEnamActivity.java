...
public class GameEnamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_enam);
...
//            tv_p1.setText("Poin: " + playerPoints);
    ...
    private void checkEnd() {
        if (back_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GameEnamActivity.this);
            alertDialogBuilder
//                    .setMessage("PERMAINAN SELESAI!\nPoin Kamu: " + playerPoints)
                    ...
                    .setPositiveButton("Permainan Baru", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), GameEnamActivity.class);
    ...
    private void frontOfCardsResources() {
        gambar101 = R.drawable.waugame;
        gambar102 = R.drawable.lamalifgame;
        gambar103 = R.drawable.hamzahgame;
        gambar104 = R.drawable.hakgame;
        gambar105 = R.drawable.yagame;
        gambar201 = R.drawable.waugame2;
        gambar202 = R.drawable.lamalifgame2;
        gambar203 = R.drawable.hamzahgame2;
        gambar204 = R.drawable.hagame2;
        gambar205 = R.drawable.yagame2;
    }
}
