...
public class PilganDuaActivity extends AppCompatActivity {
    ...
    SoalPilihanGandaDua soalPG = new SoalPilihanGandaDua();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pilgan_dua);
    ...
    public void setKonten(){
        ...
        arr = soalPG.pertanyaandua.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(PilganDuaActivity.this, HasilSkoringActivity.class);
