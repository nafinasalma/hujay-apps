...
public class EsayLimaActivity extends AppCompatActivity {
    ...
    SoalEsayLima essay = new SoalEsayLima();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_esay_lima);
    ...
    public void setKonten(){
        ...
        arr = essay.pertanyaanesaylima.length;
        if(x >= arr){
            String jumlahSkor = String.valueOf(skor);
            Intent i = new Intent(EsayLimaActivity.this, HasilSkoringActivity.class);
