...
public class NulisEmpatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        canvasFragments.add(new CanvasFragment("tho"));
        canvasFragments.add(new CanvasFragment("dzo"));
        canvasFragments.add(new CanvasFragment("ain"));
        canvasFragments.add(new CanvasFragment("ghoin"));
        canvasFragments.add(new CanvasFragment("fa"));
