...
public class NulisTigaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        canvasFragments.add(new CanvasFragment("zain"));
        canvasFragments.add(new CanvasFragment("sin"));
        canvasFragments.add(new CanvasFragment("syin"));
        canvasFragments.add(new CanvasFragment("shod"));
        canvasFragments.add(new CanvasFragment("dhod"));
