...
public class GameLimaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_lima);
    ...
    private void checkEnd() {
        if (back_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GameLimaActivity.this);
            alertDialogBuilder
                    ...
                    .setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), GameLimaActivity.class);
    ...
    private void frontOfCardsResources() {
        gambar101 = R.drawable.zonk;
        gambar102 = R.drawable.qofgame;
        gambar103 = R.drawable.kafgame;
        gambar104 = R.drawable.lamgame;
        gambar105 = R.drawable.mimgame;
        gambar106 = R.drawable.nungame;
        gambar201 = R.drawable.zonk2;
        gambar202 = R.drawable.qofgame2;
        gambar203 = R.drawable.kafgame2;
        gambar204 = R.drawable.lamgame2;
        gambar205 = R.drawable.mimgame2;
        gambar206 = R.drawable.nungame2;
    }
}
